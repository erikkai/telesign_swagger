...
OpenAPI (formerly known as <a href="https://swagger.io/docs/specification/v3_0/about/">Swagger</a>*) is an API description format for REST APIs. You can use OpenAPI to describe an entire API, including endpoints, operations available for the end points, parameter input and output, and many authentication methods (but not all). You can write your specification in YAML or JSON, and there are a variety of editors and tools to help you. 
...
Documentation for Standard products is available at <a href="https://developer.telesign.com">developer.telesign.com</a>.
...
Documentation for Enterprise products is available at <a href="https://developer.telesign.com/enterprise/">developer.telesign.com/enterprise/</a>.
